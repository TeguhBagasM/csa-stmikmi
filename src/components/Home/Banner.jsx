  ...
  return (
    <section className="h-full max-h-[640px] mb-8 xl:mb-24 dark:bg-bg-gray-950">
      <div className="flex flex-col lg:flex-row">
        ...
        >
          <h1 className="text-4xl lg:text-[48px] font-semibold leading-none mb-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
