        ...
        <div data-aos="fade-up" className="mt-12 mb-14 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <ol className="mt-4 text-gray-600 dark:text-gray-400 text-left list-decimal list-inside">
              <li>
                Mengembangkan Potensi Anggota secara Kreatif: Mengadakan program pembelajaran dan
                pelatihan yang mencakup keterampilan teknis dalam pemrograman, desain multimedia,
                pengembangan IoT, dan pembuatan game
              </li>
              <li>
